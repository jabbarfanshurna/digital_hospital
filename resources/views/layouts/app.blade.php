...
<body class="h-full font-sans antialiased text-gray-900 bg-gray-50" x-data="{ sidebarOpen: false }" x-cloak>
        ...
        <div class="lg:pl-72 flex flex-col flex-1 min-h-screen">
            ...
            <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 items-center justify-end">
                    <h1 class="text-xl font-semibold text-gray-900 flex-1 overflow-hidden text-ellipsis whitespace-nowrap ml-4 lg:ml-0">
                        {{ $header ?? 'Dashboard' }}
                    </h1>
