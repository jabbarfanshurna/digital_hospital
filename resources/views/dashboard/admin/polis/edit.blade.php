                ...
                <form action="{{ route('admin.polis.update', $poli->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6 max-w-xl">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:border-teal-500 focus:ring-teal-500">{{ old('description', $poli->description) }}</textarea>
                    ...
                    <div class="flex items-center gap-4 mt-8">
                        <x-primary-button class="bg-teal-600 hover:bg-teal-700">Update Poli</x-primary-button>
