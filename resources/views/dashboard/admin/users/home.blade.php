            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="text-center py-8 text-gray-500 border-2 border-dashed border-gray-200 rounded-lg">
                        ...
                        <button class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-md text-sm hover:bg-indigo-700 disabled:opacity-50 cursor-not-allowed" disabled>Buat Janji Temu (Segera)</button>
                    </div>
                </div>
