                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="text" name="name" id="name" :value="old('name')" required autofocus class="block w-full px-3 py-3 border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 sm:text-sm" placeholder="Nama Anda">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="email" name="email" id="email" :value="old('email')" required class="block w-full px-3 py-3 border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 sm:text-sm" placeholder="nama@email.com">
                        </div>
                    ...
                    <div>
                        ...
                        <select id="role" name="role" class="mt-1 block w-full pl-3 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-lg">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="password" name="password" id="password" required autocomplete="new-password" class="block w-full px-3 py-3 border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 sm:text-sm" placeholder="Minimal 8 karakter">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="password" name="password_confirmation" id="password_confirmation" required class="block w-full px-3 py-3 border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 sm:text-sm" placeholder="Ulangi kata sandi">
                        </div>
